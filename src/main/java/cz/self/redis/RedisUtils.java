...
/***
 * Redis client的辅助工具类 * 用于连接Redis服务器 创建不同的Redis Server对应的客户端对象 * @author wangnian * 博客地址：http://my.oschina.net/wangnian
 */
public class RedisUtils {
    ...
    public static RedisUtils getInstance() {
        if (redisUtils == null) synchronized (RedisUtils.class) {
    ...
    /**
     * 使用config创建Redisson * Redisson是用于连接Redis Server的基础类 * @param config * @return
     */
    ...
    /**
     * 使用ip地址和端口创建Redisson * @param ip * @param port * @return
     */
    ...
    /**
     * 关闭Redisson客户端连接 * @param redisson
     */
    ...
    /**
     * 获取字符串对象 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取Map对象 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取有序集合 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取集合 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取列表 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取队列 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取双端队列 * @param redisson * @param objectName * @return
     */
    public <V> RDeque<V> getRDeque(RedissonClient redisson, String objectName) {
        RDeque<V> rDeque = redisson.getDeque(objectName);
        return rDeque;
    }
    /** * 此方法不可用在Redisson 1.2 中 * 在1.2.2版本中 可用 * @param redisson * @param objectName * @return */
    ...
    /**
     * 获取锁 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取原子数 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取记数锁 * @param redisson * @param objectName * @return
     */
    ...
    /**
     * 获取消息的Topic * @param redisson * @param objectName * @return
     */
